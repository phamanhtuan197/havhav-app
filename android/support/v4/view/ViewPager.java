...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C01991();
    ...
    private static final Interpolator sInterpolator = new C02002();
    ...
    private final Runnable mEndScrollRunnable = new C02013();
    ...
    static class C01991 implements Comparator<ItemInfo> {
        C01991() {
        }
