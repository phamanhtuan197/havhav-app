...
class TypefaceCompatBaseImpl implements TypefaceCompatImpl {
    ...
    class C03411 implements StyleExtractor<FontInfo> {
        C03411() {
        }
    ...
    class C03422 implements StyleExtractor<FontFileResourceEntry> {
        C03422() {
        }
    ...
    protected FontInfo findBestInfo(FontInfo[] fonts, int style) {
        return (FontInfo) findBestFont(fonts, style, new C03411());
    }
    ...
    private FontFileResourceEntry findBestEntry(FontFamilyFilesResourceEntry entry, int style) {
        return (FontFileResourceEntry) findBestFont(entry.getEntries(), style, new C03422());
    }
