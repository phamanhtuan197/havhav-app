...
public class FontsContractCompat {
    ...
    private static final Comparator<byte[]> sByteArrayComparator = new C01845();
    ...
    static class C01845 implements Comparator<byte[]> {
        C01845() {
        }
    ...
    public static void requestFont(@NonNull final Context context, @NonNull final FontRequest request, @NonNull final FontRequestCallback callback, @NonNull Handler handler) {
        ...
        handler.post(new Runnable() {
            ...
            class C01774 implements Runnable {
                C01774() {
                }
            ...
            class C01796 implements Runnable {
                C01796() {
                }
            ...
            class C01818 implements Runnable {
                C01818() {
                }
                ...
                try {
                    ...
                    if (result.getStatusCode() != 0) {
                        switch (result.getStatusCode()) {
                            case 1:
                                callerThreadHandler.post(new C01752());
                                return;
                            case 2:
                                callerThreadHandler.post(new C01763());
                                return;
                            default:
                                callerThreadHandler.post(new C01774());
                                return;
                        }
                    }
                    FontInfo[] fonts = result.getFonts();
                    if (fonts == null || fonts.length == 0) {
                        callerThreadHandler.post(new C01785());
                        return;
                    }
                    for (FontInfo font : fonts) {
                        if (font.getResultCode() != 0) {
                            ...
                            if (resultCode < 0) {
                                callerThreadHandler.post(new C01796());
                                return;
                            } else {
                    ...
                    if (typeface == null) {
                        callerThreadHandler.post(new C01818());
                    } else {
                        callerThreadHandler.post(new Runnable() {
                            public void run() {
                    ...
                    callerThreadHandler.post(new C01741());
                }
            }
        });
    }
