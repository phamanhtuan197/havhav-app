...
public class NotificationCompat {
    ...
    public static abstract class Style {
        ...
        public RemoteViews applyStandardTemplate(boolean showSmallIcon, int resId, boolean fitIn1U) {
            ...
            if (this.mBuilder.mLargeIcon != null) {
                if (VERSION.SDK_INT >= 16) {
                    ...
                    contentView.setImageViewBitmap(C0004R.id.icon, this.mBuilder.mLargeIcon);
                } else {
                ...
                if (showSmallIcon && this.mBuilder.mNotification.icon != 0) {
                    ...
                    if (VERSION.SDK_INT >= 21) {
                        contentView.setImageViewBitmap(C0004R.id.right_icon, createIconWithBackground(this.mBuilder.mNotification.icon, backgroundSize, iconSize, this.mBuilder.getColor()));
                    } else {
                        contentView.setImageViewBitmap(C0004R.id.right_icon, createColoredBitmap(this.mBuilder.mNotification.icon, -1));
                    }
                ...
                contentView.setViewVisibility(C0004R.id.icon, 0);
                if (VERSION.SDK_INT >= 21) {
                    contentView.setImageViewBitmap(C0004R.id.icon, createIconWithBackground(this.mBuilder.mNotification.icon, res.getDimensionPixelSize(C0004R.dimen.notification_large_icon_width) - res.getDimensionPixelSize(C0004R.dimen.notification_big_circle_margin), res.getDimensionPixelSize(C0004R.dimen.notification_small_icon_size_as_large), this.mBuilder.getColor()));
                } else {
                    contentView.setImageViewBitmap(C0004R.id.icon, createColoredBitmap(this.mBuilder.mNotification.icon, -1));
                }
            }
            if (this.mBuilder.mContentTitle != null) {
                contentView.setTextViewText(C0004R.id.title, this.mBuilder.mContentTitle);
            }
            if (this.mBuilder.mContentText != null) {
                contentView.setTextViewText(C0004R.id.text, this.mBuilder.mContentText);
                showLine3 = true;
            }
            boolean hasRightSide = VERSION.SDK_INT < 21 && this.mBuilder.mLargeIcon != null;
            if (this.mBuilder.mContentInfo != null) {
                contentView.setTextViewText(C0004R.id.info, this.mBuilder.mContentInfo);
                ...
                if (this.mBuilder.mNumber > res.getInteger(C0004R.integer.status_bar_notification_info_maxnum)) {
                    ...
                    contentView.setTextViewText(C0004R.id.info, NumberFormat.getIntegerInstance().format((long) this.mBuilder.mNumber));
                }
                contentView.setViewVisibility(C0004R.id.info, 0);
                showLine3 = true;
                hasRightSide = true;
            ...
            if (this.mBuilder.mSubText != null && VERSION.SDK_INT >= 16) {
                contentView.setTextViewText(C0004R.id.text, this.mBuilder.mSubText);
                if (this.mBuilder.mContentText != null) {
                    contentView.setTextViewText(C0004R.id.text2, this.mBuilder.mContentText);
            ...
            if (this.mBuilder.getWhenIfShowing() != 0) {
                if (!this.mBuilder.mUseChronometer || VERSION.SDK_INT < 16) {
                    ...
                    contentView.setLong(C0004R.id.time, "setTime", this.mBuilder.getWhenIfShowing());
                } else {
                    contentView.setViewVisibility(C0004R.id.chronometer, 0);
                    contentView.setLong(C0004R.id.chronometer, "setBase", this.mBuilder.getWhenIfShowing() + (SystemClock.elapsedRealtime() - System.currentTimeMillis()));
                    contentView.setBoolean(C0004R.id.chronometer, "setStarted", true);
                }
                hasRightSide = true;
            }
            contentView.setViewVisibility(C0004R.id.right_side, hasRightSide ? 0 : 8);
            contentView.setViewVisibility(C0004R.id.line3, showLine3 ? 0 : 8);
            return contentView;
        }
        ...
        private Bitmap createIconWithBackground(int iconId, int size, int iconSize, int color) {
            int i = C0004R.drawable.notification_icon_background;
            if (color == 0) {
                color = 0;
            }
