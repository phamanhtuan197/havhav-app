...
class GhostViewApi14 extends View implements GhostViewImpl {
    ...
    private final OnPreDrawListener mOnPreDrawListener = new C00731();
    int mReferences;
    ViewGroup mStartParent;
    View mStartView;
    final View mView;

    class C00731 implements OnPreDrawListener {
        C00731() {
        }
    ...
    private static void setGhostView(@NonNull View view, GhostViewApi14 ghostView) {
        view.setTag(C0077R.id.ghost_view, ghostView);
    }

    static GhostViewApi14 getGhostView(@NonNull View view) {
        return (GhostViewApi14) view.getTag(C0077R.id.ghost_view);
    }
}
