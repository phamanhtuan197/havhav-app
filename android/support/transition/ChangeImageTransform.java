...
public class ChangeImageTransform extends Transition {
    ...
    private static final TypeEvaluator<Matrix> NULL_MATRIX_EVALUATOR = new C00671();
    ...
    static class C00671 implements TypeEvaluator<Matrix> {
        C00671() {
        }
    ...
    private static Matrix copyImageMatrix(ImageView view) {
        switch (C00693.$SwitchMap$android$widget$ImageView$ScaleType[view.getScaleType().ordinal()]) {
            case 1:
