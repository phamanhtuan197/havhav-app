...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C04111();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C04122();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C03673();

    class C03673 implements ViewPropertyAnimatorUpdateListener {
        C03673() {
        }
    ...
    class C04111 extends ViewPropertyAnimatorListenerAdapter {
        C04111() {
        }
    ...
    class C04122 extends ViewPropertyAnimatorListenerAdapter {
        C04122() {
        }
