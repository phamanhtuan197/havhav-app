...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    private final OnItemTouchListener mOnItemTouchListener = new C03942();
    ...
    class C03942 implements OnItemTouchListener {
        C03942() {
        }
    ...
    class C03965 implements ChildDrawingOrderCallback {
        C03965() {
        }
    ...
    private void addChildDrawingOrderCallback() {
        if (VERSION.SDK_INT < 21) {
            if (this.mChildDrawingOrderCallback == null) {
                this.mChildDrawingOrderCallback = new C03965();
            }
