...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    class C02571 extends DataSetObserver {
        C02571() {
        }
    ...
    class C02582 implements OnGlobalLayoutListener {
        C02582() {
        }
    ...
    class C02593 extends AccessibilityDelegate {
        C02593() {
        }
    ...
    class C02605 extends DataSetObserver {
        C02605() {
        }
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mModelDataSetObserver = new C02571();
        this.mOnGlobalLayoutListener = new C02582();
        ...
        expandButton.setAccessibilityDelegate(new C02593());
        ...
        this.mAdapter.registerDataSetObserver(new C02605());
