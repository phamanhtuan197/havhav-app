...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    public static abstract class LayoutManager {
        ...
        private final Callback mHorizontalBoundCheckCallback = new C03901();
        ...
        private final Callback mVerticalBoundCheckCallback = new C03912();
        private int mWidth;
        ...
        class C03912 implements Callback {
            C03912() {
            }
    ...
    class C03874 implements ProcessCallback {
        C03874() {
        }
    ...
    class C03885 implements Callback {
        C03885() {
        }
    ...
    class C03896 implements Callback {
        C03896() {
        }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mViewInfoProcessCallback = new C03874();
        if (attrs != null) {
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C03885());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C03896());
    }
