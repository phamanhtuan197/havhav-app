...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    class C02531 extends AnimatorListenerAdapter {
        C02531() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C02531();
        this.mRemoveActionBarHideOffset = new C02542();
        this.mAddActionBarHideOffset = new C02553();
        init(context);
