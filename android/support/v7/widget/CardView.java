...
public class CardView extends FrameLayout implements CardViewDelegate {
    ...
    private void initialize(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray a = context.obtainStyledAttributes(attrs, C0240R.styleable.CardView, defStyleAttr, C0240R.style.CardView_Light);
        int backgroundColor = a.getColor(C0240R.styleable.CardView_cardBackgroundColor, 0);
