...
public class ListMenuItemView extends LinearLayout implements ItemView {
    ...
    protected void onFinishInflate() {
        ...
        this.mTitleView = (TextView) findViewById(C0239R.id.title);
        if (this.mTextAppearance != -1) {
            this.mTitleView.setTextAppearance(this.mTextAppearanceContext, this.mTextAppearance);
        }
        this.mShortcutView = (TextView) findViewById(C0239R.id.shortcut);
        this.mSubMenuArrowView = (ImageView) findViewById(C0239R.id.submenuarrow);
