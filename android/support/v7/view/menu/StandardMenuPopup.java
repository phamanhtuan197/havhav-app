...
final class StandardMenuPopup extends MenuPopup implements OnDismissListener, OnItemClickListener, MenuPresenter, OnKeyListener {
    ...
    private final OnAttachStateChangeListener mAttachStateChangeListener = new C02502();
    private int mContentWidth;
    private final Context mContext;
    private int mDropDownGravity = 0;
    private final OnGlobalLayoutListener mGlobalLayoutListener = new C02491();
    ...
    class C02491 implements OnGlobalLayoutListener {
        C02491() {
        }
    ...
    class C02502 implements OnAttachStateChangeListener {
        C02502() {
        }
