...
public class TextInputLayout extends LinearLayout implements WithHint {
    ...
    class C00452 extends AnimatorListenerAdapter {
        C00452() {
        }
    ...
    class C00474 implements OnClickListener {
        C00474() {
        }
    ...
    class C00485 implements AnimatorUpdateListener {
        C00485() {
        }
    ...
    static class SavedState extends AbsSavedState {
        ...
        static class C00491 implements ClassLoaderCreator<SavedState> {
            C00491() {
            }
    ...
    public TextInputLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0014R.styleable.TextInputLayout, defStyleAttr, C0014R.style.Widget_Design_TextInputLayout);
        this.mHintEnabled = a.getBoolean(C0014R.styleable.TextInputLayout_hintEnabled, true);
        setHint(a.getText(C0014R.styleable.TextInputLayout_android_hint));
        this.mHintAnimationEnabled = a.getBoolean(C0014R.styleable.TextInputLayout_hintAnimationEnabled, true);
        if (a.hasValue(C0014R.styleable.TextInputLayout_android_textColorHint)) {
            ColorStateList colorStateList = a.getColorStateList(C0014R.styleable.TextInputLayout_android_textColorHint);
            this.mFocusedTextColor = colorStateList;
            this.mDefaultTextColor = colorStateList;
        }
        if (a.getResourceId(C0014R.styleable.TextInputLayout_hintTextAppearance, -1) != -1) {
            setHintTextAppearance(a.getResourceId(C0014R.styleable.TextInputLayout_hintTextAppearance, 0));
        }
        this.mErrorTextAppearance = a.getResourceId(C0014R.styleable.TextInputLayout_errorTextAppearance, 0);
        boolean errorEnabled = a.getBoolean(C0014R.styleable.TextInputLayout_errorEnabled, false);
        boolean counterEnabled = a.getBoolean(C0014R.styleable.TextInputLayout_counterEnabled, false);
        setCounterMaxLength(a.getInt(C0014R.styleable.TextInputLayout_counterMaxLength, -1));
        this.mCounterTextAppearance = a.getResourceId(C0014R.styleable.TextInputLayout_counterTextAppearance, 0);
        this.mCounterOverflowTextAppearance = a.getResourceId(C0014R.styleable.TextInputLayout_counterOverflowTextAppearance, 0);
        this.mPasswordToggleEnabled = a.getBoolean(C0014R.styleable.TextInputLayout_passwordToggleEnabled, false);
        this.mPasswordToggleDrawable = a.getDrawable(C0014R.styleable.TextInputLayout_passwordToggleDrawable);
        this.mPasswordToggleContentDesc = a.getText(C0014R.styleable.TextInputLayout_passwordToggleContentDescription);
        if (a.hasValue(C0014R.styleable.TextInputLayout_passwordToggleTint)) {
            this.mHasPasswordToggleTintList = true;
            this.mPasswordToggleTintList = a.getColorStateList(C0014R.styleable.TextInputLayout_passwordToggleTint);
        }
        if (a.hasValue(C0014R.styleable.TextInputLayout_passwordToggleTintMode)) {
            this.mHasPasswordToggleTintMode = true;
            this.mPasswordToggleTintMode = ViewUtils.parseTintMode(a.getInt(C0014R.styleable.TextInputLayout_passwordToggleTintMode, -1), null);
        }
        a.recycle();
    ...
    private void setEditText(EditText editText) {
        ...
        this.mEditText.addTextChangedListener(new C00441());
    ...
    public void setErrorEnabled(boolean enabled) {
        if (this.mErrorEnabled != enabled) {
            ...
            if (enabled) {
                ...
                this.mErrorView.setId(C0014R.id.textinput_error);
    ...
    private void setError(@Nullable final CharSequence error, boolean animate) {
        ...
        if (this.mErrorShown) {
            ...
            if (animate) {
                ...
                this.mErrorView.animate().alpha(1.0f).setDuration(200).setInterpolator(AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR).setListener(new C00452()).start();
            } else {
    ...
    public void setCounterEnabled(boolean enabled) {
        if (this.mCounterEnabled != enabled) {
            if (enabled) {
                ...
                this.mCounterView.setId(C0014R.id.textinput_counter);
                if (this.mTypeface != null) {
    ...
    void updateCounter(int length) {
        ...
        if (this.mCounterMaxLength == -1) {
            ...
            this.mCounterView.setText(getContext().getString(C0014R.string.character_counter_pattern, new Object[]{Integer.valueOf(length), Integer.valueOf(this.mCounterMaxLength)}));
        }
        ...
        if (this.mEditText != null) {
            ...
            if (shouldShowPasswordIcon()) {
                if (this.mPasswordToggleView == null) {
                    this.mPasswordToggleView = (CheckableImageButton) LayoutInflater.from(getContext()).inflate(C0014R.layout.design_text_input_password_icon, this.mInputFrame, false);
                    ...
                    this.mPasswordToggleView.setOnClickListener(new C00474());
                }
    ...
    void animateToExpansionFraction(float target) {
        if (this.mCollapsingTextHelper.getExpansionFraction() != target) {
            if (this.mAnimator == null) {
                ...
                this.mAnimator.addUpdateListener(new C00485());
            }
