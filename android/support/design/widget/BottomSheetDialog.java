...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    class C00313 implements OnTouchListener {
        C00313() {
        }
    ...
    class C03242 extends AccessibilityDelegateCompat {
        C03242() {
        }
    ...
    class C03254 extends BottomSheetCallback {
        C03254() {
        }
    ...
    public BottomSheetDialog(@NonNull Context context, @StyleRes int theme) {
        ...
        this.mBottomSheetCallback = new C03254();
    ...
    private View wrapInBottomSheet(int layoutResId, View view, LayoutParams params) {
        FrameLayout container = (FrameLayout) View.inflate(getContext(), C0014R.layout.design_bottom_sheet_dialog, null);
        CoordinatorLayout coordinator = (CoordinatorLayout) container.findViewById(C0014R.id.coordinator);
        if (layoutResId != 0 && view == null) {
            view = getLayoutInflater().inflate(layoutResId, coordinator, false);
        }
        FrameLayout bottomSheet = (FrameLayout) coordinator.findViewById(C0014R.id.design_bottom_sheet);
        ...
        coordinator.findViewById(C0014R.id.touch_outside).setOnClickListener(new C00301());
        ViewCompat.setAccessibilityDelegate(bottomSheet, new C03242());
        bottomSheet.setOnTouchListener(new C00313());
        return container;
    }
    ...
    private static int getThemeResId(Context context, int themeId) {
        ...
        if (context.getTheme().resolveAttribute(C0014R.attr.bottomSheetDialogTheme, outValue, true)) {
            return outValue.resourceId;
        }
        return C0014R.style.Theme_Design_Light_BottomSheetDialog;
    }
}
