...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    static final Handler sHandler = new Handler(Looper.getMainLooper(), new C00221());
    private final AccessibilityManager mAccessibilityManager;
    private List<BaseCallback<B>> mCallbacks;
    private final ContentViewCallback mContentViewCallback;
    private final Context mContext;
    private int mDuration;
    final Callback mManagerCallback = new C03183();
    private final ViewGroup mTargetParent;
    final SnackbarBaseLayout mView;

    static class C00221 implements Callback {
        C00221() {
        }
    ...
    class C00247 extends AnimatorListenerAdapter {
        C00247() {
        }
    ...
    class C00269 implements AnimationListener {
        C00269() {
        }
    ...
    static class SnackbarBaseLayout extends FrameLayout {
        ...
        SnackbarBaseLayout(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, C0014R.styleable.SnackbarLayout);
            if (a.hasValue(C0014R.styleable.SnackbarLayout_elevation)) {
                ViewCompat.setElevation(this, (float) a.getDimensionPixelSize(C0014R.styleable.SnackbarLayout_elevation, 0));
            }
            a.recycle();
            setClickable(true);
        }
    ...
    class C03183 implements Callback {
        C03183() {
        }
    ...
    class C03194 implements OnDismissListener {
        C03194() {
        }
    ...
    class C03205 implements OnAttachStateChangeListener {
    ...
    class C03216 implements OnLayoutChangeListener {
        C03216() {
        }
    ...
    protected BaseTransientBottomBar(@NonNull ViewGroup parent, @NonNull View content, @NonNull ContentViewCallback contentViewCallback) {
        if (parent == null) {
            ...
            this.mView = (SnackbarBaseLayout) LayoutInflater.from(this.mContext).inflate(C0014R.layout.design_layout_snackbar, this.mTargetParent, false);
            ...
            ViewCompat.setOnApplyWindowInsetsListener(this.mView, new C03172());
    ...
    final void showView() {
        if (this.mView.getParent() == null) {
            ...
            if (lp instanceof CoordinatorLayout.LayoutParams) {
                ...
                behavior.setListener(new C03194());
                clp.setBehavior(behavior);
                clp.insetEdge = 80;
            }
            this.mTargetParent.addView(this.mView);
        }
        this.mView.setOnAttachStateChangeListener(new C03205());
        if (!ViewCompat.isLaidOut(this.mView)) {
            this.mView.setOnLayoutChangeListener(new C03216());
    ...
    void animateViewIn() {
        if (VERSION.SDK_INT >= 12) {
            ...
            animator.addListener(new C00247());
        ...
        Animation anim = AnimationUtils.loadAnimation(this.mView.getContext(), C0014R.anim.design_snackbar_in);
        anim.setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
        anim.setDuration(250);
        anim.setAnimationListener(new C00269());
    ...
    private void animateViewOut(final int event) {
        ...
        Animation anim = AnimationUtils.loadAnimation(this.mView.getContext(), C0014R.anim.design_snackbar_out);
        anim.setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
        anim.setDuration(250);
