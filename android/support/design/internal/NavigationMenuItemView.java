...
public class NavigationMenuItemView extends ForegroundLinearLayout implements ItemView {
    ...
    class C03141 extends AccessibilityDelegateCompat {
        C03141() {
        }
    ...
    public NavigationMenuItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mAccessibilityDelegate = new C03141();
        setOrientation(0);
        LayoutInflater.from(context).inflate(C0014R.layout.design_navigation_menu_item, this, true);
        this.mIconSize = context.getResources().getDimensionPixelSize(C0014R.dimen.design_navigation_icon_size);
        this.mTextView = (CheckedTextView) findViewById(C0014R.id.design_menu_item_text);
    ...
    private void setActionView(View actionView) {
        if (actionView != null) {
            if (this.mActionArea == null) {
                this.mActionArea = (FrameLayout) ((ViewStub) findViewById(C0014R.id.design_menu_item_action_area_stub)).inflate();
            }
            this.mActionArea.removeAllViews();
    ...
    public void setIcon(Drawable icon) {
        if (icon != null) {
            ...
            if (this.mEmptyDrawable == null) {
                this.mEmptyDrawable = ResourcesCompat.getDrawable(getResources(), C0014R.drawable.navigation_empty_icon, getContext().getTheme());
                if (this.mEmptyDrawable != null) {
