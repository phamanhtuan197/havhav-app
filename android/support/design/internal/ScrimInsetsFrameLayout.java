...
public class ScrimInsetsFrameLayout extends FrameLayout {
    ...
    class C03151 implements OnApplyWindowInsetsListener {
        C03151() {
        }
    ...
    public ScrimInsetsFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0014R.styleable.ScrimInsetsFrameLayout, defStyleAttr, C0014R.style.Widget_Design_ScrimInsetsFrameLayout);
        this.mInsetForeground = a.getDrawable(C0014R.styleable.ScrimInsetsFrameLayout_insetForeground);
        a.recycle();
        setWillNotDraw(true);
        ViewCompat.setOnApplyWindowInsetsListener(this, new C03151());
    }
